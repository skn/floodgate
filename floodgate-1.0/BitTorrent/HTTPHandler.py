...
class HTTPConnector(object):
    ...
    def read_header(self, data):
        ...
        if data == '':
            ...
            (responsecode, responsestring, headers, data) = r
            print "before calling getfucnt data len = %d" % len(data)
            if r is not None:
                self.answer(r)
            return None
        try:
    ...
    def answer(self, (responsecode, responsestring, headers, data)):
        print "length data in begin answer= %d" % len(data)
        ...
        if not self.pre1:
            ...
            print "content length in answe = %d" % len(data)
