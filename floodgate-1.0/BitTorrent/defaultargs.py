...
tracker_options = [
    ...
    ('max_incomplete', MAX_INCOMPLETE,
     _("max number of outgoing incomplete connections")),
     ('micropayment_certificate', "",
     _("pem certificate that contains public key signed by CA of tracker organisation")),
     ('micropayment_trusted_ca_dir', "",
     _("directory containing self signed certificates os CAs in PEM format")),
      ('micropayment_private_key', "",
     _("pem encoded private key file")),
     ('micropayment_peer_certificates_dir', "",
     _("pem certificates of peers that contain public key signed by CA of tracker organisation")),
    ]
...
def get_defaults(ui):
    ...
    if ui == 'bittorrent-console' :
        r.extend([
            ...
            ('micropayment_private_key', "",
            _("pem encoded private key file")),
            ('micropayment_tracker_certificate', "",
            _("pem encoded certficate file of tracker")),
            ('exit_when_complete', False,
            _("stop running program if download completes")),
